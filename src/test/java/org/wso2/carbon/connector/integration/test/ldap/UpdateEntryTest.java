...
public class UpdateEntryTest {
    ...
    public void testupdateEntryWithReplace() throws Exception {
        ...
        try {
            ...
            updateEntry.connect(messageContext);Assert.assertEquals((messageContext.getEnvelope().getBody().
    ...
    public void testUpdateEntryWithWrongParameters() throws Exception {
        ...
        try {
            ...
            try {
                ...
                String Message="[LDAP: error code 32 - Unable to modify entry 'uid=testDim22,ou=People,dc=wso2,dc=com'" +
                ...
                System.out.println(messageContext.getEnvelope().getBody());
            }
        } finally {
            deleteSampleEntry();
        }
